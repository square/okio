...
class HashingSinkTest {
  @Test fun md5() {
    val data = Buffer()
    val hash = (data as Sink).hashMd5()
    Okio.buffer(hash).writeUtf8("Hi!").close()
    assertThat(data.readUtf8()).isEqualTo("Hi!")
    assertThat(hash.hash().hex()).isEqualTo("5360706c803a759e3a9f2ca54a651950")
  }

  @Test fun sha1() {
    val data = Buffer()
    val hash = (data as Sink).hashSha1()
    Okio.buffer(hash).writeUtf8("Hi!").close()
    assertThat(data.readUtf8()).isEqualTo("Hi!")
  ...
  @Test fun sha256() {
    val data = Buffer()
    val hash = (data as Sink).hashSha256()
    Okio.buffer(hash).writeUtf8("Hi!").close()
    assertThat(data.readUtf8()).isEqualTo("Hi!")
  ...
  @Test fun sha512() {
    val data = Buffer()
    val hash = (data as Sink).hashSha512()
    Okio.buffer(hash).writeUtf8("Hi!").close()
    assertThat(data.readUtf8()).isEqualTo("Hi!")
    assertThat(hash.hash().hex()).isEqualTo(
  ...
  @Test fun hmacSha1() {
    val data = Buffer()
    val hash = (data as Sink).hashHmacSha1(ByteString.encodeUtf8("donut"))
    Okio.buffer(hash).writeUtf8("Hi!").close()
    assertThat(data.readUtf8()).isEqualTo("Hi!")
  ...
  @Test fun hmacSha256() {
    val data = Buffer()
    val hash = (data as Sink).hashHmacSha256(ByteString.encodeUtf8("donut"))
    Okio.buffer(hash).writeUtf8("Hi!").close()
    assertThat(data.readUtf8()).isEqualTo("Hi!")
    assertThat(hash.hash().hex()).isEqualTo(
  ...
  @Test fun hmacSha512() {
    val data = Buffer()
    val hash = (data as Sink).hashHmacSha512(ByteString.encodeUtf8("donut"))
    Okio.buffer(hash).writeUtf8("Hi!").close()
    assertThat(data.readUtf8()).isEqualTo("Hi!")
    assertThat(hash.hash().hex()).isEqualTo(
